          ...
          <Section
            ...
            action={
              <Button size="sm" className="gap-1.5">
                <Stethoscope className="h-4 w-4" /> Start next
              </Button>
            }
          >
          ...
          <Section title="Patient timeline" description="Rohan Verma · UHID 20418">
            <div className="space-y-4">
              {[
                ...
                { t: "3 days ago", title: "Lab: Lipid Profile", meta: "LDL 168 mg/dL — elevated" },
                {
                  ...
                  meta: "Advised beta-blocker start",
                },
            ...
            <div className="mt-4 rounded-lg border border-dashed border-accent/40 bg-accent/[0.04] p-3 text-xs text-muted-foreground">
              <div className="mb-1 flex items-center gap-1.5 text-accent">
                ...
                <span className="font-semibold">AI Clinical Summary</span>
              </div>
              Hypertensive male, 42y, elevated LDL. Consider titrating anti-hypertensive and
          ...
          <Section title="Quick actions" description="Shortcuts for this shift">
            <div className="grid grid-cols-2 gap-3">
              {[
                ...
                <button
                  key={a.label}
                  className="group flex items-center gap-3 rounded-lg border border-border bg-card p-3 text-left transition hover:border-accent/60 hover:shadow-[var(--shadow-elegant)]"
                >
