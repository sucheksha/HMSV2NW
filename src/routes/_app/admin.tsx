...
function AdminDashboard() {
  return (
    <main className="min-w-0 flex-1 overflow-x-clip">
      ...
      {/* PATIENT + REVENUE CHARTS */}
      <div className="grid grid-cols-1 gap-4 px-4 sm:px-6 xl:grid-cols-3">
        <Section
        ...
        <Section
          ...
          description="Last 6 months, in ₹ lakhs"
          className="min-w-0"
        >
          <div className="h-60 w-full min-w-0 sm:h-72">
            <ResponsiveContainer width="100%" height="100%">
      ...
      {/* APPOINTMENT QUEUE + NOTIFICATIONS */}
      <div className="grid grid-cols-1 gap-4 px-4 pt-4 sm:px-6 xl:grid-cols-3">
        <Section
        ...
        >
          <ul className="space-y-2.5">
            {notifications.map((n) => {
              const tone =
                n.type === "critical" ? "danger" : n.type === "warning" ? "warning" : "info";

              return (
                <li
                  key={n.id}
                  className="flex min-w-0 items-start gap-3 rounded-lg border border-border/70 bg-background/60 p-3"
                >
      ...
      <div className="px-4 pt-4 pb-6 sm:px-6">
        <Section
          ...
          description="Patients & revenue this week"
          className="min-w-0"
        >
          <div className="h-60 w-full min-w-0 sm:h-72">
            <ResponsiveContainer width="100%" height="100%">
